...
empresa1 = Empresa('Empresa', 'C.C', 1450368974, 'z78*sd36+AA', 123431, 
                    '29/02/23', 'Programador de Software', 5, 'Ingenieria en Software', 
                    'Mis Zapatillas', 12345, 'Asociativa', 'miszapatillas@hotmail.com')
